        ...
        <div className="bs-section">
            <div className="container">
                ...
                <div className="sec-cont bs-img-desc typ-vertical">
                  ...
                  <div className="action-wrap">
                     {data.brochure ? <a href={`https://strapi.amada.ae${data.brochure.url}`}  className="bs-btn btn-default download-btn" target="_blank"><span className="icon icon-download"></span>download brochure</a> : null}  
                       {data.ebookLink ? <a href={data.ebookLink}  className="bs-btn btn-default download-btn" target="_blank"><span className="icon icon-download"></span>download e-book</a>:null}
                       {data.youtubeVideo ?<a href={data.youtubeVideo}  className="bs-btn btn-default download-btn" target="_blank"><span className="icon icon-download"></span>watch product video</a> : null}
                   </div> 
                </div>
            </div>
        </div>
...
export default ProductWithPara
